...
( function( $ ) {
   ...
   }).not(".null").not(".btn").after('&nbsp;<span class="fa fa-external-link-alt" title="External Link"></span>');
   $(".link-external").append('<span class="fa fa-caret-right" title="External Link"></span>');
   $("main p a[href*=\\.csv]").after('&nbsp;<span class="fa fa-file-alt" title="Comma Separated File></span>');
   $("main p a[href*=\\.xlsx]").after('&nbsp;<span class="fa fa-file-excel" title="Excel Document"></span>');
   $("main p a[href*=\\.pdf]").after('&nbsp;<span class="fa fa-file-pdf" title="PDF Document"></span>');
   $("main p a[href*=\\.pptx]").after('&nbsp;<span class="fa fa-file-powerpoint" title="PowerPoint Document"></span>');
   $("main p a[href*=\\.docx]").after('&nbsp;<span class="fa fa-file-word" title="Word Document"></span>');

   $.expr[':'].mailto = function(obj) {return obj.href.match(/^mailto\:/);};
   $('main p a:mailto').after('&nbsp;<span class="fa fa-envelope" title="Email"></span>');
   $('.btn-download').prepend('<span class="fa fa-download" title="Download"></span>&nbsp;');
   ...
   $('.list-icons a').filter(function() {
      return host_t = this.hostname.substr(this.hostname.length - 7, 7), host_l = location.hostname.substr(location.hostname.length - 7, 7), host_t && host_t !== host_l;
   }).before('<span class="fa fa-external-link-alt"></span>&nbsp;');
   $(".list-icons a[href*=\\.csv]").before('<span class="fa fa-file-alt" title="Comma Separated File"></span>&nbsp;');
   $(".list-icons a[href*=\\.xlsx]").before('<span class="fa fa-file-excel" title="Excel Document"></span>&nbsp;');
   $(".list-icons a[href*=\\.pdf]").before('<span class="fa fa-file-pdf" title="PDF Document"></span>&nbsp;');
   $(".list-icons a[href*=\\.pptx]").before('<span class="fa fa-file-powerpoint" title="PowerPoint Document"></span>&nbsp;');
   $(".list-icons a[href*=\\.docx]").before('<span class="fa fa-file-word" title="Word Document"></span>&nbsp;');

   $.expr[':'].fax = function(obj) {return obj.href.match(/^fax\:/);};
   $('ul.list-icons a:fax').prepend('<span class="fa fa-fax" title="Fax"></span>&nbsp;');

   $.expr[':'].mailto = function(obj) {return obj.href.match(/^mailto\:/);};
   $('ul.list-icons a:mailto').prepend('<span class="fa fa-envelope" title="Email"></span>&nbsp;');
   $.expr[':'].tel = function(obj) {return obj.href.match(/^tel\:/);};
   $('ul.list-icons a:tel').prepend('<span class="fa fa-phone" title="Phone"></span>&nbsp;');
   $('ul.list-icons li.user a').prepend('<span class="fa fa-user" title="User"></span>&nbsp;');
   $('ul.list-icons li.map a').prepend('<span class="fa fa-map-marker-alt" title="Location"></span>&nbsp;');
